...
class CausalSelfAttention(nn.Module):
    ...
    def forward(self, x, layer_cache=None):
        ...
        return self.fc_out(out), new_layer_cache
...
class MiniGPT(nn.Module):
    def __init__(self, vocab_size, embed_size, max_seq_length, num_layers, heads):
        super().__init__()
        self.embeddings = Embeddings(vocab_size, embed_size, max_seq_length)
